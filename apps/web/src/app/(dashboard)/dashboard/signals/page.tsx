    ...
    <>
      ...
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
        ...
        <div className="flex items-center gap-2 text-xs">
          <button className="px-3 py-1.5 border hairline hover:bg-muted flex items-center gap-1.5">
            <Bell className="w-3 h-3" /> Notify on new
          </button>
          <button className="px-3 py-1.5 bg-primary text-primary-foreground hover:opacity-90 flex items-center gap-1.5">
        ...
        <div className="fixed inset-0 z-50 bg-foreground/20" onClick={() => setOpen(null)}>
          <aside className="absolute right-0 top-0 h-full w-full max-w-md bg-background border-l hairline p-6 flex flex-col gap-5 overflow-y-auto"
            ...
            <div className="flex items-center gap-2">
              ...
              <button className="px-3 py-2.5 border hairline text-xs hover:bg-muted">Manual</button>
            </div>
          </aside>
        </div>
      )}
